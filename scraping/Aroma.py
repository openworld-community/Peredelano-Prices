...
def scraping(urlAroma, collection_name):
    ...
    list_Aroma_MMF_urls = list()

    for temp_url in list_Aroma_urls:
        ...
        for tile in tiles:
            ...
            list_Aroma_MMF_urls.append(Href)
            # print(Href)

    counter = 0
    for url in list_Aroma_MMF_urls:
        # print(url)
        # print("\n")
